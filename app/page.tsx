      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="w-24 h-24 bg-white rounded-3xl mx-auto mb-6 flex items-center justify-center shadow-2xl">
            <i className="fas fa-shield-alt text-5xl text-indigo-600"></i>
          </div>
          <h1 className="text-5xl font-bold text-white mb-4">The Choice Engine</h1>
          <p className="text-2xl text-white/90 mb-2">Complete Interactive Prototype</p>
          <p className="text-lg text-white/70">Next.js Version - Snap • Analyze • Save</p>
        </div>
        ...
        {/* Key Features */}
        <div className="mb-12">
          <h2 className="text-3xl font-bold text-white text-center mb-8">Key Product Features</h2>
